...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#030303] text-white selection:bg-gym-red selection:text-white font-sans overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-16 px-8 min-h-screen flex flex-col justify-center border-b border-white/5 overflow-hidden">
        ...
        >
          <p className="font-['Brush_Script_MT',cursive] text-6xl text-white/30">
            Same People<br/>Stronger Stories
          </p>
        </motion.div>
        ...
        <div className="max-w-7xl mx-auto w-full relative z-20 flex-1 flex flex-col justify-center">
          <motion.div 
            ...
            className="max-w-3xl"
          >
            <motion.p variants={fadeUp} className="text-white/60 text-[10px] font-bold tracking-[0.4em] uppercase mb-6 flex flex-col gap-2">
              <span>Discipline Today</span>
              <span>A Stronger Tomorrow</span>
            </motion.p>
            <motion.h1 variants={fadeUp} className="text-6xl md:text-8xl lg:text-[100px] font-black uppercase tracking-tighter leading-[0.85] mb-8 drop-shadow-2xl">
              Invest In<br/>
              <span className="text-gym-red inline-block mt-2">Your Strength</span>
            </motion.h1>
            <motion.p variants={fadeUp} className="text-white/60 text-lg md:text-xl font-medium max-w-md mb-12 leading-relaxed">
              More than a gym. A community that helps you build a stronger, healthier and better you.
            </motion.p>
            
            <motion.div variants={fadeUp} className="flex flex-wrap items-center gap-4">
              <Link to="/register?plan=3m" className="bg-gym-red hover:bg-red-600 text-white px-10 py-5 text-sm font-bold uppercase tracking-widest transition-all duration-300 shadow-[0_0_30px_rgba(255,51,51,0.4)] hover:shadow-[0_0_50px_rgba(255,51,51,0.6)] flex items-center gap-2">
                Join Now <ArrowRight className="w-5 h-5" />
              </Link>
              <a href="#plans" className="border border-white/20 hover:border-white hover:bg-white hover:text-black text-white px-10 py-5 text-sm font-bold uppercase tracking-widest transition-all duration-300">
                View Plans
              </a>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            <span className="text-[8px] font-bold tracking-[0.2em] uppercase">Scroll Down</span>
          </motion.div>
        </div>
      </section>
      ...
      <section className="border-b border-white/5 bg-[#050505] relative z-20">
        <div className="max-w-7xl mx-auto px-8 py-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="flex items-center gap-4 group">
              <Users className="w-10 h-10 text-gym-red group-hover:scale-110 transition-transform" />
              <div>
                <h3 className="text-2xl font-black">500+</h3>
                <p className="text-[10px] text-white/50 font-bold uppercase tracking-widest">Happy Members</p>
              </div>
            </motion.div>
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }} className="flex items-center gap-4 group">
              ...
              <div>
                ...
                <p className="text-[10px] text-white/50 font-bold uppercase tracking-widest">Equipment</p>
              </div>
            </motion.div>
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }} className="flex items-center gap-4 group">
              ...
              <div>
                ...
                <p className="text-[10px] text-white/50 font-bold uppercase tracking-widest">Guidance</p>
              </div>
            </motion.div>
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.3 }} className="flex items-center gap-4 group">
              ...
              <div>
                ...
                <p className="text-[10px] text-white/50 font-bold uppercase tracking-widest">Community</p>
              </div>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row">
          <div className="flex-1 px-8 py-8 flex flex-wrap items-center gap-12 border-r border-white/5">
            <div className="flex items-center gap-4 group cursor-pointer">
              ...
              <div>
                <p className="font-black text-sm uppercase tracking-wider">Kariyapatti</p>
                <p className="text-[10px] text-white/50 font-bold uppercase tracking-widest">Tamil Nadu, 626106</p>
              </div>
            </div>
            
            <a href="tel:+917904458158" className="flex items-center gap-4 group cursor-pointer">
              <div className="w-12 h-12 rounded-full bg-gym-red/10 flex items-center justify-center group-hover:bg-gym-red transition-colors">
                <Phone className="w-5 h-5 text-gym-red group-hover:text-white transition-colors" />
              </div>
              <div>
                <p className="font-black text-sm uppercase tracking-wider">+91 79044 58158</p>
                <p className="text-[10px] text-white/50 font-bold uppercase tracking-widest">Call Us</p>
              </div>
            </a>
            
            {/* Functional WhatsApp Link */}
            <a href="https://wa.me/917904458158" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 group cursor-pointer">
              ...
              <div>
                <p className="font-black text-sm uppercase tracking-wider">WhatsApp</p>
                <p className="text-[10px] text-white/50 font-bold uppercase tracking-widest">Chat Now</p>
              </div>
            </a>
          </div>
          ...
          <div className="bg-gym-red/5 border-l-4 border-l-gym-red p-8 flex items-center justify-center lg:w-96 relative overflow-hidden group">
            ...
            <h3 className="text-2xl font-black uppercase tracking-widest text-center leading-tight">
              Train Harder<br/><span className="text-gym-red">Live Better</span>
            </h3>
          </div>
        </div>
      </section>
      ...
      {/* 5. ABOUT SECTION */}
      <section id="about" className="py-32 px-8 border-b border-white/5 relative overflow-hidden">
        {/* Glow */}
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <motion.div 
            ...
            variants={staggerContainer}
          >
            <motion.p variants={fadeUp} className="text-gym-red text-[10px] font-bold tracking-[0.3em] uppercase mb-4">About Fit Zone</motion.p>
            <motion.h2 variants={fadeUp} className="text-5xl md:text-7xl font-black uppercase tracking-tighter leading-[0.9] mb-8">
              More Than<br/><span className="text-gym-red">A Gym</span>
            </motion.h2>
            <motion.p variants={fadeUp} className="text-white/60 text-base leading-relaxed mb-12">
              FIT ZONE is Kariyapatti's premier fitness destination. We provide world-class equipment, expert guidance and a motivating environment to help you become the best version of yourself.
            </motion.p>
            
            <motion.div variants={fadeUp} className="grid grid-cols-3 gap-8 mb-12 border-t border-white/10 pt-8">
              <div>
                <h4 className="text-4xl font-black text-gym-red mb-1">500<span className="text-2xl">+</span></h4>
                <p className="text-[10px] font-bold uppercase tracking-widest text-white/50">Members</p>
              </div>
              <div>
                <h4 className="text-4xl font-black mb-1">2<span className="text-2xl">+</span></h4>
                <p className="text-[10px] font-bold uppercase tracking-widest text-white/50">Years</p>
              </div>
              <div>
                <h4 className="text-4xl font-black mb-1">100<span className="text-2xl">%</span></h4>
                <p className="text-[10px] font-bold uppercase tracking-widest text-white/50">Commitment</p>
              </div>
            </motion.div>

            <motion.button variants={fadeUp} className="bg-gym-red hover:bg-red-600 text-white px-8 py-4 text-xs font-bold uppercase tracking-widest transition-colors flex items-center gap-2">
          ...
          >
            <img src="https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=2070&auto=format&fit=crop" alt="Gym Floor" className="w-full h-full object-cover grayscale brightness-75 rounded-sm" />
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              <p className="text-gym-red text-[10px] font-bold tracking-[0.3em] uppercase mb-4">Membership Plans</p>
              <h2 className="text-5xl font-black uppercase tracking-tighter">Simple Plans. Bigger Results.</h2>
            </motion.div>
            <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="text-white/40 text-[10px] font-bold tracking-[0.2em] uppercase hidden md:block text-right">
              Choose a plan.<br/>Start your transformation.
            </motion.p>
          </div>
      ...
      <section id="facilities" className="py-32 px-8 border-b border-white/5 relative overflow-hidden">
        <div className="absolute right-0 top-0 w-1/3 h-full opacity-10 grayscale">
          <img src="https://images.unsplash.com/photo-1558611848-73f7eb4001a1?q=80&w=2071&auto=format&fit=crop" alt="Bg" className="w-full h-full object-cover mask-image-gradient-l" />
        </div>
        ...
        <div className="max-w-7xl mx-auto relative z-10 flex flex-col lg:flex-row gap-16 items-start">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="lg:w-1/3">
            <p className="text-gym-red text-[10px] font-bold tracking-[0.3em] uppercase mb-4">Facilities</p>
            ...
            <p className="text-white/40 text-[10px] font-bold tracking-[0.2em] uppercase leading-loose text-right">
              Premium Equipment.<br/>Perfect Environment.<br/>No Excuses.
            </p>
          </motion.div>
          ...
          <div className="lg:w-2/3 grid grid-cols-2 md:grid-cols-3 gap-4">
            {[
              ...
              >
                ...
                <span className="text-[10px] font-bold uppercase tracking-widest text-white/70 group-hover:text-white transition-colors whitespace-pre-line leading-relaxed">{f.label}</span>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      {/* 8. GALLERY SECTION */}
      <section id="gallery" className="py-32 border-b border-white/5 overflow-hidden">
        <div className="max-w-7xl mx-auto px-8 mb-12 flex flex-col md:flex-row justify-between items-end">
          <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
            <p className="text-gym-red text-[10px] font-bold tracking-[0.3em] uppercase mb-4">Gallery</p>
            <h2 className="text-5xl font-black uppercase tracking-tighter mb-4">Inside<br/>Fit Zone</h2>
            <p className="text-white/50 text-sm">Real people. Real workouts.<br/>Real results.</p>
          </motion.div>
          <motion.button initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="mt-8 md:mt-0 border border-white/20 hover:border-white text-white px-8 py-4 text-[10px] font-bold uppercase tracking-widest transition-colors flex items-center gap-2">
        ...
        <div className="flex overflow-x-auto gap-4 px-8 pb-8 snap-x hide-scrollbar">
          {[
            ...
            >
              {item.src ? (
                <>
                  <img src={item.src} alt="Gallery" className="w-full h-full object-cover grayscale brightness-75 group-hover:grayscale-0 group-hover:scale-105 group-hover:brightness-100 transition-all duration-700" />
      ...
      <section className="py-32 px-8 border-b border-white/5 relative overflow-hidden">
        ...
        <div className="absolute right-0 top-0 w-1/2 h-full opacity-20 pointer-events-none hidden lg:block">
          <img src="https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?q=80&w=2070&auto=format&fit=crop" alt="Back" className="w-full h-full object-cover mask-image-gradient-l grayscale" />
        </div>

        <div className="max-w-7xl mx-auto relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-16">
            <p className="text-gym-red text-[10px] font-bold tracking-[0.3em] uppercase mb-4">What Our Members Say</p>
            <h2 className="text-5xl font-black uppercase tracking-tighter">Real People. Real Results.</h2>
          </motion.div>

          <div className="grid md:grid-cols-3 gap-6 lg:w-3/4">
            {[
              { name: "Arun Prakash", role: "Member", text: "Best gym in Kariyapatti! Clean, spacious and great trainers. Highly recommended!" },
              { name: "Vijay Kumar", role: "Member", text: "Amazing atmosphere and equipment. The trainers are very supportive. Totally worth it!" },
              { name: "Karthik Raja", role: "Member", text: "FIT ZONE has completely changed my lifestyle. More than a gym, it's a family." }
            ].map((review, idx) => (
              <motion.div 
                key={idx}
                initial={{ opacity: 0, y: 30 }}
              ...
              >
                ...
                <p className="text-white/70 text-sm leading-relaxed mb-8 h-24">{review.text}</p>
                ...
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 bg-white/10 rounded-full overflow-hidden">
                    <img src={`https://i.pravatar.cc/150?img=${idx + 11}`} alt="Avatar" className="w-full h-full object-cover grayscale" />
                  </div>
                  <div>
                    <h4 className="font-bold text-sm uppercase tracking-wider">{review.name}</h4>
                    <p className="text-[10px] text-white/50 uppercase tracking-widest">{review.role}</p>
                  </div>
                </div>
              </motion.div>
            ))}
          ...
          >
            <p className="font-['Brush_Script_MT',cursive] text-6xl text-white/20 transform -rotate-12">
              Stronger People<br/>Stronger Community
            </p>
          </motion.div>
        </div>
      </section>
      ...
      {/* 10. LOCATION SECTION */}
      <section id="contact" className="py-32 px-8 border-b border-white/5 bg-[#050505]">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
            <p className="text-gym-red text-[10px] font-bold tracking-[0.3em] uppercase mb-4">Our Location</p>
            <h2 className="text-5xl font-black uppercase tracking-tighter mb-8">Visit Us Today</h2>
            <div className="flex items-start gap-4 mb-12">
              <MapPin className="w-6 h-6 text-white shrink-0 mt-1" />
              <p className="text-white/70 text-sm leading-loose">
                1st Floor, Muthu Finance,<br/>
                Jeevaa St, K Karaisal Kulam,<br/>
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <a href="tel:+917904458158" className="border border-white/20 hover:border-white text-white px-8 py-4 text-[10px] font-bold uppercase tracking-widest transition-colors flex items-center gap-2">
                <Phone className="w-4 h-4" /> Call
              </a>
              <a href="https://wa.me/917904458158" target="_blank" rel="noopener noreferrer" className="border border-white/20 hover:border-[#25D366] hover:text-[#25D366] text-white px-8 py-4 text-[10px] font-bold uppercase tracking-widest transition-colors flex items-center gap-2">
                <MessageCircle className="w-4 h-4" /> WhatsApp
              </a>
            </div>
          </motion.div>
          
          <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} className="relative h-[400px] flex items-center">
            <div className="absolute inset-0 bg-[#080808] rounded-sm overflow-hidden border border-white/5">
              <img src="https://images.unsplash.com/photo-1524661135-423995f22d0b?q=80&w=2074&auto=format&fit=crop" alt="Map Route" className="w-full h-full object-cover grayscale opacity-20" />
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="flex flex-col items-center">
                  <MapPin className="w-10 h-10 text-gym-red mb-2 animate-bounce" />
                  <span className="text-gym-red font-bold text-xs tracking-widest uppercase">Fit Zone Gym</span>
                  <span className="text-white/50 text-[10px] tracking-wider uppercase mt-1">Kariyapatti</span>
                </div>
              </div>
            </div>
            ...
            <div className="hidden lg:block absolute -right-16 bg-[#030303] py-8 pl-8 pr-16 border-l-2 border-gym-red z-10">
              <h3 className="text-xl font-bold uppercase tracking-[0.3em] leading-loose text-white/50">
                Fitness<br/>Health<br/>Discipline<br/><span className="text-white">A Better You</span>
              </h3>
            </div>
          </motion.div>
        </div>
      ...
      <footer className="py-16 px-8 bg-[#030303]">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-12">
          <div className="flex flex-col items-center md:items-start gap-4">
            ...
            <p className="text-white/40 text-[10px] font-bold tracking-widest uppercase">Stronger People. Stronger Community.</p>
          </div>
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            <div className="flex flex-col items-center gap-2 mt-4">
              <p className="text-white/20 text-[10px] tracking-widest uppercase">© 2026 FIT ZONE GYM. All rights reserved.</p>
              <div className="flex gap-4 text-white/40 text-[10px] font-bold tracking-widest uppercase">
                ...
                <span>|</span>
                <Link to="/login?type=admin" className="hover:text-white transition-colors">Admin Login</Link>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-6">
            ...
            <a href="#" className="ml-4 w-10 h-10 border border-white/10 flex items-center justify-center hover:bg-white hover:text-black transition-colors text-white/50">
